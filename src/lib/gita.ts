...
const CHAPTER_LEDE_EN: Record<number, string> = {
  ...
  3: "If you must act — and you must — how do you act without becoming bound by your own actions? Karma yoga is the answer.",
  ...
  7: "Knowledge of the divine in two forms — the manifest and the unmanifest. Why few seek, fewer find, and rarer still understand.",
  ...
  10: "The divine glories. Wherever you find excellence — strength, beauty, wisdom — Krishna is its seed. A chapter to read and look around.",
  11: "Arjuna asks to see. Krishna shows him. The universal form — terrifying, vast, the cosmos with its mouths open. The Gita's most cinematic chapter.",
  ...
  16: "Two natures — divine and demoniac. Not as cosmic factions but as tendencies in every person. The chapter is a mirror.",
...
const CHAPTER_LEDE_HI: Record<number, string> = {
  ...
  3: "यदि कर्म करना ही है — और है — तो उसमें बँधे बिना कैसे करें? कर्म योग का उत्तर यही है।",
  4: "ज्ञान यज्ञ। कर्म समर्पण। कृष्ण अपने अवतारों और योग की प्राचीन परंपरा का स्मरण कराते हैं।",
